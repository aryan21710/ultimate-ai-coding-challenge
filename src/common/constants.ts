...
export const stackUsedAnimText =
  'REACT HOOKS- TYPESCRIPT - MATERIAL UI  - WEBPACK - ESLINT ';
export const footerText =
  '@Ultimate-AI Copyrighted by Aryan Sharma 04/2021. All Rights Reserved.';
export const setupWizardLink = 'AI-Bot Setup Wizard';
export const getStartedLink = 'Get Started';
export const bkgVideoUrl =
  'https://media.giphy.com/media/l49JGOWSDMAmOlSa4/giphy.mp4';
...
export const listOfIntents = [
    ...
    },
    {
        ...
        name: 'Negative',
        description:
      'The user confirms that they don\'t need help / something is not true or similar.',
        trainingData: {
            expressionCount: 129,
            expressions: [
                {
    ...
    },
    {
        ...
        name: 'Are you a bot?',
        description:
      'The user wants to know if they are talking to a bot or a human.',
        trainingData: {
            expressionCount: 83,
            expressions: [
                {
